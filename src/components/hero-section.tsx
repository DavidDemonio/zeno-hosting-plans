...
export function HeroSection({ language }: HeroSectionProps) {
  ...
  const { title, highlight, description, primaryButton, secondaryButton } = content[language as keyof typeof content];
    ...
    <section className="relative py-32 md:py-40 lg:py-48 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 stagger-animation stagger-4">
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-zeno-purple to-zeno-blue hover:opacity-90 transition-all text-white relative overflow-hidden group hover-lift"
