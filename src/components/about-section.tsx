      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <Button 
              className="bg-gradient-to-r from-zeno-purple to-zeno-blue hover:opacity-90 transition-all text-white hover:shadow-glow group"
            ...
            <div className="bg-zinc-800/30 backdrop-blur-sm rounded-lg border border-zinc-700 p-8">
              ...
              <div className="mt-6 text-right">
                <motion.button
                  ...
                  className="text-zeno-purple hover:text-white inline-flex items-center text-sm group"
